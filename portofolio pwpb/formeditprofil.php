...
<input type="hidden" name="id" value="<?php echo $tampilproduk['id']?>">
        ...
        <div class="form-group row ">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control mb-4 text-dark" id="url_gambar" name="gambar_profil" style="background-color:#ffffff; border:solid 2px; border-color:black;"  value="<?php echo $tampilproduk['gambar_profil']?>">
          </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control mb-4 text-dark" id="txt_namaproduk" name="nama_profil"  style="background-color:#ffffff; border:solid 2px; border-color:black;"  value="<?php echo $tampilproduk['nama_profil']?>">
            </div>
        </div>
        ...
        <div class="form-group row ">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control mb-5 text-dark" id="txt_hargaproduk" name="isi_profil"  style="background-color:#ffffff; border:solid 2px; border-color:black;"  value="<?php echo $tampilproduk['isi_profil']?>">
            </div>
        </div>
